...
public class Incorrect_Password extends TestBase{
	...
	String sPathOFScreenshot1 = System.getProperty("user.dir")+"//screenshot/screenshot_Incorrect_Password.png";
	
	public Incorrect_Password() {
